...
public class IdentifyServiceImpl implements  IdentifyService{
    ...
    public  void  getCheckCode(String phone) throws ClientException {
        //获取验证码
        String checkCode = SaltUtil.getCheckCode();
        //设置超时时间-可自行调整
        ...
        //替换成你的AK
        final String accessKeyId = "LTAIS7qKWaDMVAp6";//你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "sLxo1X0eQOJDJBzRD0b2IgyVHKnAlY";//你的accessKeySecret，参考本文档步骤2
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("最爱雨天");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_136840001");
